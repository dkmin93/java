...
public class ArraySearch02 {
	...
	public static void main(String[] args) {
		...
		//1~100까지 정렬되어있는 숫자가 있을 때, 75를 찾는다. 업다운
		//이진탐색 : 어떤값을 찾을 때 반을 분할해서 찾는 방법
		//조건 : 반드시 값이 순서대로 정렬
		 ...
		 * 2. 포인터의 중간값을 구함
		 * 3. 중간값이 찾는값인지 확인함
		 * 4. 찾는값이 중간값보다 크면 start를 중간값 + 1 로 올림
		...
		int start = 0;
		int end = arr.length-1; // 마지막 인덱스 배열은 0부터 시작함
